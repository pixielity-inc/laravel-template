...
class Container_ec3e8359bb extends _PHPStan_b6c48a07e\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0440(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_ec3e8359bb $container)
			{
	...
	public function createServiceContainer(): Container_ec3e8359bb
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'level' => 8,
			'paths' => [
				'/Users/akouta/Projects/MNGO/laravel-template/app',
