...
class Container_26b2e24d12 extends _PHPStan_b6c48a07e\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0440(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_26b2e24d12 $container)
			{
	...
	public function createServiceContainer(): Container_26b2e24d12
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'MEILISEARCH_KEY' => 'masterKeySecure123456',
				...
				'_' => '/Users/akouta/Library/Application Support/Herd/bin/php84',
				...
				'APP_DEBUG' => 'false',
				'APP_KEY' => 'base64:1Xx46J3lrvpqCVhkprlLwBCothivtGIBQHTYyKaIwQk=',
				'LINES' => '25',
				'REDIS_DB' => '0',
				'XPC_SERVICE_NAME' => '0',
