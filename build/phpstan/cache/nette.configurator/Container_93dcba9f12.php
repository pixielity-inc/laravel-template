...
class Container_93dcba9f12 extends _PHPStan_b6c48a07e\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0440(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_93dcba9f12 $container)
			{
	...
	public function createServiceContainer(): Container_93dcba9f12
	{
		return $this;
	}
