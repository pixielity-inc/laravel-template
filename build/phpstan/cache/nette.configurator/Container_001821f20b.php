...
class Container_001821f20b extends _PHPStan_b6c48a07e\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0440(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_001821f20b $container)
			{
	...
	public function createServiceContainer(): Container_001821f20b
	{
		return $this;
	}
