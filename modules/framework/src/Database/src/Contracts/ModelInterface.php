 ...
 *
 * Note: Trait-based features are provided by the base Model class through traits.
 * They are not part of this interface to avoid forcing all models to implement
