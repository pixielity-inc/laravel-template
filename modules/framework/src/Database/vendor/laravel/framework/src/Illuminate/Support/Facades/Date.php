 ...
 * @method static getTimeFormatByPrecision(string $unitPrecision)
 * @method static|\Closure|null getTranslationMessageWith($translator, string $key, ?string $locale = null, ?string $default = null)
 ...
 * @method static pluralUnit(string $unit)
 ...
 * @method static singularUnit(string $unit)
 ...
 * @method static translateTimeString(string $timeString, ?string $from = null, ?string $to = null, int $mode = \Carbon\CarbonInterface::TRANSLATE_ALL)
 * @method static translateWith(\Symfony\Contracts\Translation\TranslatorInterface $translator, string $key, array $parameters = [], $number = null)
