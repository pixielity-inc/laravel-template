 ...
 * @method static compileString(string $value)
 * @method static render(string $string, array $data = [], bool $deleteCachedView = false)
 * @method static renderComponent(\Illuminate\View\Component $component)
 * @method static stripParentheses(string $expression)
 ...
 * @method static usingEchoFormat(string $format, callable $callback)
 * @method static void setEchoFormat(string $format)
 * @method static void withDoubleEncoding()
 * @method static void withoutDoubleEncoding()
 * @method static void withoutComponentTags()
 * @method static getCompiledPath(string $path)
 * @method static bool isExpired(string $path)
 * @method static newComponentHash(string $component)
 * @method static compileClassComponentOpening(string $component, string $alias, string $data, string $hash)
 * @method static compileEndComponentClass()
 * @method static mixed sanitizeComponentAttribute(mixed $value)
 * @method static compileEndOnce()
 * @method static void stringable(string|callable $class, callable|null $handler = null)
 * @method static compileEchos(string $value)
 * @method static applyEchoHandler(string $value)
 *
