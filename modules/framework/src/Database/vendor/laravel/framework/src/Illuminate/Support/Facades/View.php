 ...
 * @method static renderWhen(bool $condition, string $view, \Illuminate\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static renderUnless(bool $condition, string $view, \Illuminate\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static renderEach(string $view, array $data, string $iterator, string $empty = 'raw|')
 ...
 * @method static yieldSection()
 * @method static stopSection(bool $overwrite = false)
 * @method static appendSection()
 * @method static yieldContent(string $section, string $default = '')
 * @method static parentPlaceholder(string $section = '')
 ...
 * @method static stopPush()
 * @method static void startPrepend(string $section, string $content = '')
 * @method static stopPrepend()
 * @method static yieldPushContent(string $section, string $default = '')
 ...
 * @method static renderTranslation()
 *
