 ...
 * @method static getDefaultCloudDriver()
 ...
 * @method static|null get(string $path)
 ...
 * @method static|false putFile(\Illuminate\Http\File|\Illuminate\Http\UploadedFile|string $path, \Illuminate\Http\File|\Illuminate\Http\UploadedFile|string|array|null $file = null, mixed $options = [])
 * @method static|false putFileAs(\Illuminate\Http\File|\Illuminate\Http\UploadedFile|string $path, \Illuminate\Http\File|\Illuminate\Http\UploadedFile|string|array|null $file, string|array|null $name = null, mixed $options = [])
 * @method static bool writeStream(string $path, resource $resource, array $options = [])
 * @method static getVisibility(string $path)
 ...
 * @method static|false checksum(string $path, array $options = [])
 * @method static|false mimeType(string $path)
 * @method static url(string $path)
 * @method static bool providesTemporaryUrls()
 * @method static bool providesTemporaryUploadUrls()
 * @method static temporaryUrl(string $path, \DateTimeInterface $expiration, array $options = [])
