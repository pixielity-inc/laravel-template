 ...
 * @method static get(string $path, bool $lock = false)
 ...
 * @method static|false hash(string $path, string $algorithm = 'md5')
 ...
 * @method static|null guessExtension(string $path)
 * @method static|false type(string $path)
