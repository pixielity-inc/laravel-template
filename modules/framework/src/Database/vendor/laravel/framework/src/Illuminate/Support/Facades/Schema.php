 ...
 * @method static getColumnType(string $table, string $column, bool $fullDefinition = false)
 ...
 * @method static[]|null getCurrentSchemaListing()
 * @method static|null getCurrentSchemaName()
