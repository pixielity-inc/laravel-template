 ...
 * @method static previous(mixed $fallback = false)
 * @method static previousPath(mixed $fallback = false)
 * @method static to(string $path, mixed $extra = [], bool|null $secure = null)
 * @method static query(string $path, array $query = [], mixed $extra = [], bool|null $secure = null)
 * @method static secure(string $path, array $parameters = [])
 * @method static asset(string $path, bool|null $secure = null)
 * @method static secureAsset(string $path)
 * @method static assetFrom(string $root, string $path, bool|null $secure = null)
 * @method static formatScheme(bool|null $secure = null)
 * @method static signedRoute(\BackedEnum|string $name, mixed $parameters = [], \DateTimeInterface|\DateInterval|int|null $expiration = null, bool $absolute = true)
 * @method static temporarySignedRoute(\BackedEnum|string $name, \DateTimeInterface|\DateInterval|int $expiration, array $parameters = [], bool $absolute = true)
 ...
 * @method static route(\BackedEnum|string $name, mixed $parameters = [], bool $absolute = true)
 * @method static toRoute(\Illuminate\Routing\Route $route, mixed $parameters, bool $absolute)
 * @method static action(string|array $action, mixed $parameters = [], bool $absolute = true)
 * @method static array formatParameters(mixed $parameters)
 * @method static formatRoot(string $scheme, string|null $root = null)
 * @method static format(string $root, string $path, \Illuminate\Routing\Route|null $route = null)
 ...
 * @method static getRootControllerNamespace()
