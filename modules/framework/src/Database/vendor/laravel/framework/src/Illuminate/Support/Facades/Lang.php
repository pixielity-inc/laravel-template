 ...
 * @method static|array get(string $key, array $replace = [], string|null $locale = null, bool $fallback = true)
 * @method static choice(string $key, \Countable|int|float|array $number, array $replace = [], string|null $locale = null)
