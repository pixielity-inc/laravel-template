...
return array(
    ...
    'olvlvl\\ComposerAttributeCollector\\' => array($vendorDir . '/olvlvl/composer-attribute-collector/src'),
    ...
    'Pixielity\\Workflow\\' => array($vendorDir . '/pixielity/laravel-framework/src/Workflow/src'),
    'Pixielity\\Uuid\\' => array($vendorDir . '/pixielity/laravel-framework/src/Uuid/src'),
    'Pixielity\\Support\\' => array($vendorDir . '/pixielity/laravel-framework/src/Support/src'),
    'Pixielity\\ServiceProvider\\' => array($vendorDir . '/pixielity/laravel-framework/src/ServiceProvider/src'),
    'Pixielity\\Serializer\\' => array($vendorDir . '/pixielity/laravel-framework/src/Serializer/src'),
    'Pixielity\\Routing\\' => array($vendorDir . '/pixielity/laravel-framework/src/Routing/src'),
    'Pixielity\\Response\\' => array($vendorDir . '/pixielity/laravel-framework/src/Response/src'),
    'Pixielity\\Logging\\' => array($vendorDir . '/pixielity/laravel-framework/src/Logging/src'),
    'Pixielity\\Localization\\' => array($vendorDir . '/pixielity/laravel-framework/src/Localization/src'),
    'Pixielity\\Foundation\\Tests\\' => array($baseDir . '/tests'),
    'Pixielity\\Foundation\\' => array($baseDir . '/src'),
    'Pixielity\\Enum\\' => array($vendorDir . '/pixielity/laravel-framework/src/Enum/src'),
    'Pixielity\\Discovery\\' => array($vendorDir . '/pixielity/laravel-discovery/src'),
    'Pixielity\\Database\\' => array($vendorDir . '/pixielity/laravel-framework/src/Database/src'),
    'Pixielity\\Container\\' => array($vendorDir . '/pixielity/laravel-framework/src/Container/src'),
    'Pixielity\\ColorThief\\' => array($vendorDir . '/pixielity/laravel-framework/src/ColorThief/src'),
    'Pixielity\\Actions\\' => array($vendorDir . '/pixielity/laravel-framework/src/Actions/src'),
    'Pixielity\\' => array($vendorDir . '/pixielity/laravel-framework/src'),
